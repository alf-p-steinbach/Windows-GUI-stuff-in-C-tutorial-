...
| The previous part’s box: | This part’s box with icon: |
|--------------------------|----------------------------|
| ![Minimal message box](02/images/sshot.part-1-message-box.png) | ![Message box with custom icon](02/images/sshot.part-2-message-box.png) |
