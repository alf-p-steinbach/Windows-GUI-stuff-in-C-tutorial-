...
And unfortunately, also, the GDI doesn’t (yet) support UTF-8 encoded Unicode text for *drawing* text as graphics, as opposed to using controls to present text as we did in part 4, and it doesn’t support saving an image other than as an archaic non-portable ".wmf" file. The UTF-8 shortcoming is remedied in later parts of this tutorial. This part just provides a way to programmatically save a graphic as an image file.
