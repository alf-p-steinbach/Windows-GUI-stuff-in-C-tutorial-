...
Also, the text that the program places in text fields, other controls such as buttons, and main window titles, must have the encoding expected by the Windows GUI, namely the process’ ANSI code page which we’ve now set to UTF-8:
