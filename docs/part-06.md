...
![](file://D:\root\current work\Windows GUI-stuff in C++ (tutorial)\docs\part-05\images\sshot-2.cpp-graphics-on-screen.cropped.png)
...
![asdlkj](file://D:\root\current work\Windows GUI-stuff in C++ (tutorial)\docs\part-05\images\data-flow-for-saving.png)
...
![Image in FastStone viewer](file://D:\root\current work\Windows GUI-stuff in C++ (tutorial)\docs\part-05\images\sshot-3.image-file-in-viewer.png)
