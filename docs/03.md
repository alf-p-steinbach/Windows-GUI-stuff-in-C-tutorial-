...
[*03/code/tic-tac-toe/v3/winapi_util.hpp*](03/code/tic-tac-toe/v3/winapi_util.hpp)
~~~cpp
#pragma once
#include "wrapped-windows-h.hpp"    // Safer and faster. Safe = e.g. no `small` macro.    
...
All of the above code snippets are part of the “[03/code/tic-tac-toe/v4/winapi_util.hpp](03/code/tic-tac-toe/v4/winapi_util.hpp)” file. But of course these functions need to be called in order to have any effect. That’s done in the `WM_INITDIALOG` handler in the main program:
