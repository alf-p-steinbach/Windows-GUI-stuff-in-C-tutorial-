...
*[03/code/tic-tac-toe/v3-3/reuse/winapi_support_machinery/dialog_message.hpp.hpp](03/code/tic-tac-toe/v3-3/reuse/winapi_support_machinery/dialog_message.hpp.hpp)*:
```cpp
#pragma once
#include <wrapped-windows-h.hpp>        // Safer and faster. Safe = e.g. no `small` macro.
