...
* we’ll prepare the dialog proc for handling of general window messages by value by using the undocumented `SetDlgMsgResult` macro (*most* messages require this!);
